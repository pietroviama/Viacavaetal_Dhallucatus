...
layers <- c("cl620", "cl618", "el830", "el1077", "el674")
...
vegtype$distanceToPermanentWaterWeighted[is.na(vegtype$distanceTowater)]<-0
...
Dhallucatusdata$distanceTowater <- vegtype$distanceToPermanentWaterWeighted
