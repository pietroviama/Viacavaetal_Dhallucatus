...
disparitymainisl <- morphol.disparity(coords ~ 1, groups= ~ main_island, data = gdfhallucatus, iter=499)
summary(disparitymainisl)

disparitypops <- morphol.disparity(coords~1, groups = ~ Population, data = gdfmainland, iter = 499)
